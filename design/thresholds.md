# Thresholds & numeric contract (frozen before content — game-design-system §0.6)

## Performance (game-design-system §6.5)
...
## Agency metrics (frozen before content — §5.3)
...
- Sunfish body radius ~38 px; **collision hitbox = 0.6 × visible radius**
  (player hitbox smaller than sprite — §8 forgiveness). Hazard hitboxes honest.
